...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    textSize: "lg",
    transition: "zoom",
    layout: "splitHighlight",
    image: "screenshots/card.png",
    highlight: hl["card:apply"],
    highlightStyle: "sparkleClick",
  },
  {
    text: "適用完了！",
    bg: "green",
  ...
  // === Section 3: Main Screen ===
  {
    id: "feature-intro",
    text: "① 配信情報パネル",
    sub: "今Twitchに登録されている設定を表示\nワンボタンでテンプレートに取り込めます",
    bg: "white",
    durationSec: 5,
    transition: "flash",
    layout: "splitHighlight",
    image: "screenshots/main.png",
    highlight: hl["main:info-panel"],
    enterAnimation: "shrinkFromFull",
    sectionTitle: "機能紹介",
  },
  {
    text: "② テンプレート一覧",
  ...
  },
  {
    ...
    transition: "crossfade",
    layout: "splitHighlight",
    image: "screenshots/empty.png",
    highlight: hl["empty:add-button"],
  },
  ...
  // === Section 4: Template Creation ===
  {
    ...
    layout: "splitHighlight",
    image: "screenshots/card.png",
    highlight: hl["card:title"],
    enterAnimation: "delayedFadeIn",
    sectionTitle: "テンプレートの作り方",
  },
  {
    text: "② カテゴリを検索・選択",
    sub: "Twitch APIでリアルタイム検索",
    bg: "white",
    durationSec: 2,
    transition: "crossfade",
    layout: "splitHighlight",
    image: "screenshots/category.png",
    highlight: hl["category:dropdown"],
  },
  {
    text: "③ タグを追加",
    sub: "配信に付けるタグを設定",
  ...
  // === Section 5: Extra Features ===
  {
    ...
    layout: "splitHighlight",
    image: "screenshots/main.png",
    highlight: hl["main:import-button"],
    enterAnimation: "delayedFadeIn",
    sectionTitle: "もっと便利な機能",
  },
  {
    text: "ドラッグ&ドロップ\nで並べ替え",
    bg: "white",
    durationSec: 3,
    video: "videos/dnd-reorder.webm",
    videoStartFrom: 0.5,
    transition: "crossfade",
  },
  {
    ...
    bg: "white",
    durationSec: 3,
    video: "videos/clone-template.webm",
    videoStartFrom: 0.5,
    transition: "crossfade",
  },
  {
    ...
    bg: "white",
    durationSec: 4,
    video: "videos/search-filter.webm",
    videoStartFrom: 0.5,
    transition: "crossfade",
  },
  {
  ...
  },
  {
    ...
    transition: "crossfade",
    highlight: hl["login:twitch-button"],
    highlightStyle: "sparkleClick",
  },
  {
    text: "ボタン１つでTwitchと連携",
    bg: "gray",
    durationSec: 2,
    icon: "👆",
    transition: "crossfade",
  ...
  {
    text: "GitHub でコードも公開中",
    sub: "yuniruyuni/StreamTagInventory",
    bg: "purple",
    durationSec: 2,
    transition: "push",
    callout: "＼ オープンソース ／",
  ...
  },
  {
    ...
    durationSec: 3,
    textSize: "lg",
    sub: "Virtual TechLead\nYuniruYuni",
    footnote: "twitch.tv/yuniruyuni",
    callout: "＼ よかったらRAIDくーださい！ ／",
    image: "yuniruyuni.png",
    transition: "glow",
  },
];
